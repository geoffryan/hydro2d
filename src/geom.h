...
void geom_CM_sph_rtp(double x1[], double x2[], double xc[]);
void geom_CM2_sph_rtp(double x1[], double x2[], double xc[], int dir);
double geom_dA_sph_rtp(double x1[], double x2[], int dir);
double geom_dV_sph_rtp(double x1[], double x2[]);
